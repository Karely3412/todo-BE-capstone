...
@check_lists.route("/check-list/user/<user_id>", methods=['GET'])
def check_lists_get_by_user_id(user_id):
    return check_lists_controller.check_lists_get_by_user_id(request, user_id)
